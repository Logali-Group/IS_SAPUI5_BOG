					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Integration Suite with SAPUI5",
									"targetURL": "#integration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"integration-display": {
								"semanticObject": "integration",
								"action": "display",
								"description": "Integration Suite with SAPUI5",
								"title": "Integration Suite with SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=integration",
									"url": sap.ui.require.toUrl("integration")
								}
							}
						}
					}
